defmodule Chronic.RelativeTest do
  ...
  test "today 10am" do
    ...
    assert time == %Calendar.NaiveDateTime{year: 2015, month: 5, day: 9, hour: 10, min: 0, sec: 0, usec: 0}
    assert offset == 0
  end
  ...
  test "6 in the morning" do
    ...
    assert time == %Calendar.NaiveDateTime{year: 2015, month: 5, day: 9, hour: 6, min: 0, sec: 0, usec: 0}
    assert offset == 0
  end
